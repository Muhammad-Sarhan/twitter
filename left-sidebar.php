...
?>
           <div class="sidebar">
            <ul style="list-style:none;">
                ...
                <li class="active_menu"><a href='home.php'><i class="fa fa-home" style="color:#50b7f5;"></i><span style="color:#50b7f5;">Home</span></a></li>
                ...
                <li><a href="<?php echo "profile.php?username=".$user->username.""; ?>"><i class="fa fa-user"></i><span>Profile</span></a></li>
                <li><a href='settings/account'><i class="fa fa-cog"></i><span>Settings</span></a></li>
                <li><a href='includes/logout.php'><i class="fa fa-power-off"></i><span>Logout</span></a></li>
